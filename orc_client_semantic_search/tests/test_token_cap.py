...
Until 18.0.0.3.0 upstream (19.0.1.1.0 on this branch)
``daily_token_cap`` was declared on the config model, rendered in
the Settings form, described in README as
